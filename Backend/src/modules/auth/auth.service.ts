 ...
 */
  async loginWithGoogle(
    ...
    if (identity) {
      ...
      return this.resolveAuthState(identity.user, input.tenantId, context);
    }
    ...
    if (!existingUser) {
      ...
      return this.resolveAuthState(created, input.tenantId, context);
    }
    ...
    return this.resolveAuthState(linked, input.tenantId, context);
  }
